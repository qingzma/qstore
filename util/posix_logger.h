#ifndef QSTORE_UTIL_POSIX_LOGGER_H_
#define QSTORE_UTIL_POSIX_LOGGER_H_
...
class PosixLogger final : public Logger {
 ...
 public:
  ...
  void Logv(const char* format, std::va_list arguments) override {
    ...
    std::cout << "time is " << now_seconds << std::endl;
...
#endif  // QSTORE_UTIL_POSIX_LOGGER_H_